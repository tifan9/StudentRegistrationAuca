...
import com.example.StudentReg.model.StudentRegistration;
import com.example.StudentReg.service.StudentRegService;
...
public class StudentRegistrationController {
    ...
    @GetMapping(value = "/register/semester/{semid}/academic/{acaid}")
    public ResponseEntity<?>studentPerSemDep(@PathVariable("semid") Integer semid, @PathVariable("acaid") Integer acaid) throws  RemoteException{
        List<StudentRegistration> studpersemsDeps=studentRegService.studentsPerSemAndDep(semid,acaid);
