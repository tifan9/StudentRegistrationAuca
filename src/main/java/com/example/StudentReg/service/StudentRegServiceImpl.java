...
import com.example.StudentReg.repository.StudentRegRepository;
...
public class StudentRegServiceImpl implements StudentRegService{
    ...
    @Override
    public List<StudentRegistration> studentsPerSemAndDep(int semid, int acaid) throws RemoteException {
        return studentRegRepository.findStudentsBySemesterAndAcademicUnit(semid,acaid);
    }
